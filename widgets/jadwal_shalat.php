	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-2 col-4 px-2 py-1">
				<div class="square shalat shimmer" data-name="imsak">
				</div>
			</div>
			<div class="col-lg-2 col-4 px-2 py-1">
				<div class="square shalat shimmer"  data-name="subuh">
				</div>
			</div>
			<div class="col-lg-2 col-4 px-2 py-1">
				<div class="square shalat shimmer" data-name="dzuhur">
				</div>
			</div>
			<div class="col-lg-2 col-4 px-2 py-1">
				<div class="square shalat shimmer"  data-name="ashar">
				</div>
			</div>
			<div class="col-lg-2 col-4 px-2 py-1">
				<div class="square shalat shimmer"  data-name="maghrib">
				</div>
			</div>
			<div class="col-lg-2 col-4 px-2 py-1">
				<div class="square shalat shimmer"  data-name="isya">
				</div>
			</div>
		</div>
	</div>
