...
<script src="<?= base_url("$folder_themes/vendor/jquery/jquery.min.js") ?>"></script>
<script src="<?= base_url("$folder_themes/vendor/bootstrap/js/bootstrap.min.js") ?>"></script>
<script src="<?= base_url("$folder_themes/vendor/jquery/jquery.marquee.min.js") ?>"></script>
...
<script src="<?= base_url("$folder_themes/assets/js/script.js") ?>"></script>