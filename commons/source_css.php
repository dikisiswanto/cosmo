...
<link rel="stylesheet" href="<?= base_url("$folder_themes/vendor/jssocial/css/jssocials.css") ?>">
<link rel="stylesheet" href="<?= base_url("$folder_themes/vendor/jssocial/css/jssocials-theme-flat.css") ?>">
